...
4. [01-r2-storage-structure.ts](./01-r2-storage-structure.ts)
5. [02-r2-buckets-fallback.ts](./02-r2-buckets-fallback.ts)
6. [03-blob-store.ts](./03-blob-store.ts)
7. [04-r2-object-index.ts](./04-r2-object-index.ts)
8. [06-file-serving-security.ts](./06-file-serving-security.ts)
9. [09-r2-buckets.test.ts](./09-r2-buckets.test.ts)
10. [10-public-artifact-mirror.test.ts](./10-public-artifact-mirror.test.ts)
11. [11-source-access.ts](./11-source-access.ts)
12. [12-authored-layout.ts](./12-authored-layout.ts)
...
- control-plane shapes that make the storage contract visible
